...
def histograma_plot(df, 
  ...
  sns.histplot(data = df,
              ...
              legend= False)
  # quantiles
  ax_h.axvline(x=p10, label=f'P10: {p10} {units_label}', c='k', ls='--')
  ax_h.axvline(x=p25, label=f'Q1: {p25} {units_label}', c='b', ls='--')
  ax_h.axvline(x=p50, label=f'Q2: {p50} {units_label}', c='r', ls='--')
  ax_h.axvline(x=p75, label=f'Q3: {p75} {units_label}', c='b', ls='--')
  ax_h.axvline(x=p90, label=f'P90: {p90} {units_label}', c='k', ls='--')
